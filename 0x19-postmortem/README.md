...
About 03:00 West African Time (WAT) here in Nigeria, with the release of ALX's System Engineering & DevOps project 0x19, an outage happened on an isolated Ubuntu 14.04 container running an Apache web server. When an HTML file establishing a basic ALX WordPress site was expected as response, GET queries to the server caused 500 Internal Server Errors.
...
[0-strace_is_your_friend.pp](https://github.com/timothymayor/alx-system_engineering-devops/blob/main/0x17-web_stack_debugging_3/0-strace_is_your_friend.pp)
